            ...
            var ExplorerToolbarView = (function (_super) {
                ...
                ExplorerToolbarView.prototype.events = function () {
                    return {
                        ...
                        "click #screenshotDiv": "takeScreenShot",
                ...
                ExplorerToolbarView.prototype.initialize = function () {
                    ...
                    $.get('../templates/explorer_toolbar.html', function (data) {
                        ...
                        _this.screenshotDivEl = _this.$('#screenshotDiv');
                        _this.screenshotDivElTabIndex = +$(_this.screenshotDivEl).attr('tabindex');
                    ...
                    this.listenTo(this, "mousedown", function (e) {
                        ...
                        switch (id) {
                            ...
                            case 'fileimport':
                                ...
                                break;
                            case 'toolbar-screenshot':
                            case 'screenshot':
                                target = '#screenshotDiv';
                                break;
                ...
                ExplorerToolbarView.prototype.DisableView = function () {
                    ...
                    this.screenshotDivEl.addClass('ui-state-disabled');
                    ...
                    this.screenshotDivEl.attr('tabindex', -1);
                ...
                ExplorerToolbarView.prototype.EnableView = function () {
                    ...
                    this.screenshotDivEl.removeClass('ui-state-disabled');
                    ...
                    this.screenshotDivEl.attr('tabindex', this.screenshotDivElTabIndex);
                ...
                ExplorerToolbarView.prototype.onBtnLabelMouseEvent = function (obj) {
                    ...
                    if (obj.type === 'mouseover') {
                        ...
                        else if (forName === 'toolbar-screenshot') {
                            imgSrc += 'Asset_Altair_Main_Header_Tool_Screenshot_Hover.svg';
                        }
                        ...
                        if (forName === 'toolbar-export') {
                            ...
                            imgSrc += 'Asset_Altair_Main_Header_Tool_Screenshot_Rest.svg';
                        }
                        else if (forName === 'toolbar-setting') {
                        ...
                        if (forName === 'toolbar-export') {
                            ...
                            imgSrc += 'Asset_Altair_Main_Header_Tool_Screenshot_Pressed.svg';
                        }
                        else if (forName === 'toolbar-setting') {
