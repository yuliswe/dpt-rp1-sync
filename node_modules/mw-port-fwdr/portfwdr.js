...
const LOCAL_HTTP_PORT_BASE = 58080;
const LOCAL_HTTPS_PORT_BASE = 58443;
...
class PortFwdr {
  ...
  start(toIpAddr, toPortHttp, toPortHttps, callback) {
    ...
    this.httpForwarder = this.startForwarder(
      toIpAddr, toPortHttp,
      localHost, LOCAL_HTTP_PORT_BASE, function(err, fromHttpPort) {
        ...
        self.httpsForwarder = self.startForwarder(
          ...
          localHost, LOCAL_HTTPS_PORT_BASE, function(err, fromHttpsPort) {
   ...
   * @private
   */
  startForwarder(toIpAddr, toPort, fromHost, fromPortBase, callback) {
